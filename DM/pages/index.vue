        ...
        <div class="flex items-center justify-between gap-6 flex-col lg:gap-8 lg:flex-row">
          <div class="flex-1 bg-secondary rounded-xl p-6 lg:h-360 overflow-hidden relative w-full">
            ...
            <div class="w-72 relative z-10">
              <h2 class="text-white text-3xl font-semibold leading-normal">The Best Platform for Car Rental</h2>
              <p class="text-white mt-4 mb-5 font-medium leading-6 text-base">Ease of doing a car rental safely and reliably. Of course at a low price.</p>
          ...
          <div class="flex-1 bg-primary rounded-xl p-6 lg:h-360 overflow-hidden relative w-full">
            ...
            <div class="w-72 relative z-10">
              <h2 class="text-white text-3xl font-semibold leading-normal">Easy way to rent a car at a low price</h2>
              <p class="text-white mt-4 mb-5 font-medium leading-6 text-base">Providing cheap car rental services and safe and comfortable facilities.</p>
              <button class="bg-secondary text-white text-base font-semibold px-5 py-2.5 rounded capitalize">Rental Car</button>
            </div>
          </div>
        </div>
      </div>
